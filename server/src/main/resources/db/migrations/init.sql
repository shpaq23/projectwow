...
(
    ...
    ROLE                  varchar(36) NOT NULL DEFAULT 'PLAYER',
...
ALTER TABLE `user`
    ADD CONSTRAINT FK_USER_CHARACTER FOREIGN KEY (CHARACTER_ID) REFERENCES `character` (ID);


ALTER TABLE `character`
    ADD CONSTRAINT FK_CHARACTER_CHARACTERSTATS FOREIGN KEY (CHARACTERSTATS_ID) REFERENCES CharacterStats (ID);
ALTER TABLE `character`
